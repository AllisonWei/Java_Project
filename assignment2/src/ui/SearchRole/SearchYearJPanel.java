 ...
 * @author Lynn Wei
 */
public class SearchYearJPanel extends javax.swing.JPanel {
	JPanel p;
	List<Product> lists;
    /**
     * Creates new form SearchYearJPanel
     */
	public SearchYearJPanel(JPanel p, List<Product> lists) {
		initComponents();
	    this.p = p;
	    this.lists = lists;
	    lblYear.setText(lists.get(0).getYear()+"");
	    refreshTable();
    ...
    private void initComponents() {
        ...
        lblYear.setFont(new java.awt.Font("Yu Gothic UI Semibold", 0, 36)); // NOI18N
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(layout.createSequentialGroup()
                        ...
                        .addGap(92, 92, 92)
                        .addComponent(lblYear, javax.swing.GroupLayout.PREFERRED_SIZE, 538, javax.swing.GroupLayout.PREFERRED_SIZE)
