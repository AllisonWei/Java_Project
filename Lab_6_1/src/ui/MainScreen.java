...
public class MainScreen extends javax.swing.JPanel {
     ...
     */
    public MainScreen(JPanel mainWorkArea, UserDto userDto){
        initComponents();
    ...
    private void initUserWorkArea() {
        ...
        lblWelcome.setText("Welcome " + userDto.getPerson().getPersonName() + "!");
        
        CardLayout layout = (CardLayout) workArea.getLayout();
        workArea.add("workArea", userDto.getRole().createWorkArea(workArea, userDto));
