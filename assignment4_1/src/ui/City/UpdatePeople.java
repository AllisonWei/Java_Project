 ...
 * @author Lynn Wei
 */
public class UpdatePeople extends javax.swing.JPanel {
     ...
     */
    public UpdatePeople(javax.swing.JPanel userProcessContainer,String cityName,String communityName,String houseName,String Name) {
     ...
     public void initDate(){
         ...
         p=AppData.getPerson(cityName, communityName, houseName, Name);
        txtCommunity.setText(communityName);
        txtHouse.setText(houseName);
        txtCity.setText(cityName);
        
        txtAge.setText(p.getAge()+"");
        txtGender.setSelectedItem(p.getGender());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
            ...
            p.setCommunityName(communityName);
            p.setHouseName(houseName);
            p.setAge(Integer.valueOf(txtAge.getText()) );
            p.setGender(txtGender.getSelectedItem().toString());
            p.setName( txtName.getText());
            p.setID(txtID.getText());
            JOptionPane.showMessageDialog(null, "Update successfully", "successfully", JOptionPane.CLOSED_OPTION);
